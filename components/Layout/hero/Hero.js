...
class Hero extends React.Component {
  ...
  render() {
    return (
      <div className={cx(s.hero, this.props.className)} ref={node => (this.root = node)} style={{ backgroundImage: 'url(./images/hero-background.jpg)'}}>
        <div className={cx(s.content, this.props.className)}>
          ...
          <address className={cx(s.address, this.props.className)}>1353 Princes Hwy, Heathcote, NSW, 2233</address>
